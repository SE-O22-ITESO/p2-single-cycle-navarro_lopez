...
# ACDS 21.1 850 win32 2023.03.10.20:30:35
# ----------------------------------------
...
# ----------------------------------------
# If PLL_Intel_FPGA is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_Intel_FPGA"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "E:/intelfpga_lite/21.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_Intel_FPGA.vo"
}
